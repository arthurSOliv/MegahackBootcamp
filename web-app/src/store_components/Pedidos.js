    ...
    <div className={classes.root} style={{display: props.showPedidos ? 'block' : 'none' }}>
      ...
      <ExpansionPanel >
        ...
        <ExpansionPanelDetails className={classes.details}>
          <div className={classes.column} />
          <div className={classes.column}>
            <Chip label="Produto 1" onDelete={() => {}} />
            <Chip label="Produto 2" onDelete={() => {}} />
            <Chip label="Produto 3" onDelete={() => {}} />
          </div>
      ...
      <ExpansionPanel>
        ...
        <ExpansionPanelDetails className={classes.details}>
          <div className={classes.column} />
          <div className={classes.column}>
            <Chip label="Coca-cola" onDelete={() => {}} />
            <Chip label="Arroz" onDelete={() => {}} />
            <Chip label="Feijão" onDelete={() => {}} />
            <Chip label="Sorvete" onDelete={() => {}} />
          </div>
        </ExpansionPanelDetails>
        <Divider />
        <ExpansionPanelActions>
