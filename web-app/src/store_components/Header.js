...
export default function Header() {
  ...
  const [showPromo, setPromo] = React.useState(false);
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List>
            ...
            <ListItem button key='Pedidos'  onClick={setScreen.bind(this, 'historico')}>
                <ListItemIcon ><HistoryIcon className="menuIcon"/><Typography variant="h6" component="h2">Histórico</Typography></ListItemIcon>
                <ListItemText />
            </ListItem>
            <ListItem button key='Promoções'  onClick={setScreen.bind(this, 'promo')}>
                <ListItemIcon><StarIcon className="menuIcon"/><Typography variant="h6" component="h2">Promoções</Typography></ListItemIcon>
                <ListItemText />
            </ListItem>
